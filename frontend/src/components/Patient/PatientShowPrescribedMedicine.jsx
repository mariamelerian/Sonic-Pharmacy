...
function PatientPrescribedMedicine() {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get("/prescribedMedicines");
  ...
  const handleExpandInModal = (index) => {
    setExpandedMedicineInModal(
      expandedMedicineInModal === index ? null : index
    );
  };
      ...
      {loading ? (
        ...
        <Row>
          ...
          <Modal
            ...
            onHide={handleCloseAlternativeModal}
            ...
            <Modal.Body>
              <Row>
                {alternativeMedicines.length > 0 ? (
                  ...
                  <p>
                    No available alternatives with the same active ingredient.
                  </p>
                )}
              </Row>
            </Modal.Body>
